...
#if MBED_CONF_APP_USE_TLS_SOCKET
    static constexpr size_t REMOTE_PORT = 8080; // tls port
#else
...
public:
    ...
    void run()
    {
        ...
        while (1){
            ...
            humid = BSP_HSENSOR_ReadHumidity();
            ...
            int len = sprintf(acc_json, "{\"x\":%f,\"y\":%f,\"z\":%f,\"TEMPERATURE\":%.2f,\"HUMIDITY\":%.2f,\"PRESSURE\":%.2f,\"s\":%d}"
            , (float)((int)(x*10000))/10000,(float)((int)(y*10000))/10000, (float)((int)(z*10000))/10000, temperature, humid, pressure, sample_num);
            printf("%s\n",acc_json);
